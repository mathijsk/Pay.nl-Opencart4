 ...
 *
 * Xafax Mynetpay - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlXafaxmynetpay extends AdminController {
	protected int $paymentOptionId = 3633;
	protected string $paymentMethodName = 'paynl_xafaxmynetpay';
	protected string $defaultLabel = 'Xafax Mynetpay';
}
