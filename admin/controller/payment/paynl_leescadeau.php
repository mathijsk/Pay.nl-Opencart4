 ...
 *
 * Lees cadeau - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlLeescadeau extends AdminController {
	protected int $paymentOptionId = 4758;
	protected string $paymentMethodName = 'paynl_leescadeau';
	protected string $defaultLabel = 'Lees cadeau';
}
