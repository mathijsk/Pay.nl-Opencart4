 ...
 *
 * Beauty Cadeau - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlBeautycadeau extends AdminController {
	protected int $paymentOptionId = 3144;
	protected string $paymentMethodName = 'paynl_beautycadeau';
	protected string $defaultLabel = 'Beauty Cadeau';
}
