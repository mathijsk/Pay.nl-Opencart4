 ...
 * Class PaynlPaypal
 *
 * PayPal - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlPaypal extends AdminController {
	protected int $paymentOptionId = 138;
	protected string $paymentMethodName = 'paynl_paypal';
	protected string $defaultLabel = 'PayPal';
