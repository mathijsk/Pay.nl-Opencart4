 ...
 *
 * Sauna & Wellness cadeaukaart - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlSaunaandwellness extends AdminController {
	protected int $paymentOptionId = 4269;
	protected string $paymentMethodName = 'paynl_saunaandwellness';
	protected string $defaultLabel = 'Sauna & Wellness cadeaukaart';
}
