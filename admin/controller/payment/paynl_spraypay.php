 ...
 * Class PaynlSpraypay
 *
 * SprayPay - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlSpraypay extends AdminController {
	protected int $paymentOptionId = 1987;
	protected string $paymentMethodName = 'paynl_spraypay';
	protected string $defaultLabel = 'SprayPay';
}
