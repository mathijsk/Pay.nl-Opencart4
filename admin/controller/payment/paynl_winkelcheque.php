 ...
 *
 * WinkelCheque - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlWinkelcheque extends AdminController {
	protected int $paymentOptionId = 2616;
	protected string $paymentMethodName = 'paynl_winkelcheque';
	protected string $defaultLabel = 'WinkelCheque';
}
