...
/**
 * Class PaynlGooglepay
 *
 * Google Pay - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlGooglepay extends AdminController {
	protected int $paymentOptionId = 2558;
	protected string $paymentMethodName = 'paynl_googlepay';
	protected string $defaultLabel = 'Google Pay';
}
