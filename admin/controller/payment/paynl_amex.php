 ...
 * Class PaynlAmex
 *
 * American Express - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlAmex extends AdminController {
	protected int $paymentOptionId = 1705;
	protected string $paymentMethodName = 'paynl_amex';
	protected string $defaultLabel = 'American Express';
}
