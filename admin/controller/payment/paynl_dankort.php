 ...
 * Class PaynlDankort
 *
 * Dankort - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlDankort extends AdminController {
	protected int $paymentOptionId = 1939;
	protected string $paymentMethodName = 'paynl_dankort';
	protected string $defaultLabel = 'Dankort';
}
