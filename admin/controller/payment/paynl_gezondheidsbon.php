...
/**
 * Class PaynlGezondheidsbon
 *
 * Gezondheidsbon - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlGezondheidsbon extends AdminController {
	protected int $paymentOptionId = 812;
	protected string $paymentMethodName = 'paynl_gezondheidsbon';
	protected string $defaultLabel = 'Gezondheidsbon';
}
