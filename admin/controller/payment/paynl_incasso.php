 ...
 * Class PaynlIncasso
 *
 * Automatische incasso - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlIncasso extends AdminController {
	protected int $paymentOptionId = 137;
	protected string $paymentMethodName = 'paynl_incasso';
	protected string $defaultLabel = 'Automatische incasso';
}
