 ...
 *
 * Flying blue+ - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlFlyingblueplus extends AdminController {
	protected int $paymentOptionId = 3615;
	protected string $paymentMethodName = 'paynl_flyingblueplus';
	protected string $defaultLabel = 'Flying blue+';
}
