 ...
 *
 * Visa/Mastercard - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlVisamastercard extends AdminController {
	protected int $paymentOptionId = 706;
	protected string $paymentMethodName = 'paynl_visamastercard';
	protected string $defaultLabel = 'Visa/Mastercard';
}
