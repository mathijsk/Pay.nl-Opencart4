 ...
 *
 * Scholieren pas - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlScholierenpas extends AdminController {
	protected int $paymentOptionId = 4434;
	protected string $paymentMethodName = 'paynl_scholierenpas';
	protected string $defaultLabel = 'Scholieren pas';
}
