 ...
 *
 * Przelewy 24 - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlPrzelewy24 extends AdminController {
	protected int $paymentOptionId = 2151;
	protected string $paymentMethodName = 'paynl_przelewy24';
	protected string $defaultLabel = 'Przelewy 24';
}
