 ...
 *
 * Handmatige overboeking - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlOverboeking extends AdminController {
	protected int $paymentOptionId = 136;
	protected string $paymentMethodName = 'paynl_overboeking';
	protected string $defaultLabel = 'Handmatige overboeking';
}
