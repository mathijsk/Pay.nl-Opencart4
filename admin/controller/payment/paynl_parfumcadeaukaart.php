 ...
 *
 * Parfum cadeaukaart - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlParfumcadeaukaart extends AdminController {
	protected int $paymentOptionId = 2682;
	protected string $paymentMethodName = 'paynl_parfumcadeaukaart';
	protected string $defaultLabel = 'Parfum cadeaukaart';
}
