 ...
 * Class PaynlYourgift
 *
 * Yourgift - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlYourgift extends AdminController {
	protected int $paymentOptionId = 1645;
	protected string $paymentMethodName = 'paynl_yourgift';
	protected string $defaultLabel = 'Yourgift';
}
