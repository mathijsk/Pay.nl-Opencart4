 ...
 *
 * Babycadeaubon - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlBabycadeaubon extends AdminController {
	protected int $paymentOptionId = 4416;
	protected string $paymentMethodName = 'paynl_babycadeaubon';
	protected string $defaultLabel = 'Babycadeaubon';
}
