 ...
 *
 * Sofortbanking High Risk - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlSofortbankinghr extends AdminController {
	protected int $paymentOptionId = 595;
	protected string $paymentMethodName = 'paynl_sofortbankinghr';
	protected string $defaultLabel = 'Sofortbanking High Risk';
}
