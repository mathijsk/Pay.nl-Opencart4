 ...
 *
 * Fashion cheque Beauty - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlFashionchequebeauty extends AdminController {
	protected int $paymentOptionId = 4428;
	protected string $paymentMethodName = 'paynl_fashionchequebeauty';
	protected string $defaultLabel = 'Fashion cheque Beauty';
}
