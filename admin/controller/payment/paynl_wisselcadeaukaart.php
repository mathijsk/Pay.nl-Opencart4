 ...
 *
 * Wissel cadeaukaart - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlWisselcadeaukaart extends AdminController {
	protected int $paymentOptionId = 3735;
	protected string $paymentMethodName = 'paynl_wisselcadeaukaart';
	protected string $defaultLabel = 'Wissel cadeaukaart';
}
