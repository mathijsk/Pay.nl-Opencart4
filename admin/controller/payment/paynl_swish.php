 ...
 * Class PaynlSwish
 *
 * Swish - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlSwish extends AdminController {
	protected int $paymentOptionId = 3837;
	protected string $paymentMethodName = 'paynl_swish';
	protected string $defaultLabel = 'Swish';
}
