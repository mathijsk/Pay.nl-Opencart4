 ...
 *
 * Shoes and sneakers - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlShoesandsneakers extends AdminController {
	protected int $paymentOptionId = 2937;
	protected string $paymentMethodName = 'paynl_shoesandsneakers';
	protected string $defaultLabel = 'Shoes and sneakers';
}
