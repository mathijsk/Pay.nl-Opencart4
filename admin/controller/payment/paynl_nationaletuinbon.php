...
/**
 * Class PaynlNationaletuinbon
 *
 * Nationale tuinbon - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlNationaletuinbon extends AdminController {
	protected int $paymentOptionId = 4152;
	protected string $paymentMethodName = 'paynl_nationaletuinbon';
	protected string $defaultLabel = 'Nationale tuinbon';
}
