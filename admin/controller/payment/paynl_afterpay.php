 ...
 * Class PaynlAfterpay
 *
 * Riverty - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlAfterpay extends AdminController {
	protected int $paymentOptionId = 739;
	protected string $paymentMethodName = 'paynl_afterpay';
	protected string $defaultLabel = 'Riverty';
}
