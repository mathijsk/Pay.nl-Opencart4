...
/**
 * Class PaynlBiercheque
 *
 * Biercheque - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlBiercheque extends AdminController {
	protected int $paymentOptionId = 2622;
	protected string $paymentMethodName = 'paynl_biercheque';
	protected string $defaultLabel = 'Biercheque';
}
