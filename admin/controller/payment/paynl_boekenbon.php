...
/**
 * Class PaynlBoekenbon
 *
 * Boekenbon - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlBoekenbon extends AdminController {
	protected int $paymentOptionId = 2838;
	protected string $paymentMethodName = 'paynl_boekenbon';
	protected string $defaultLabel = 'Boekenbon';
}
