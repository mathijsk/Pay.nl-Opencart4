...
/**
 * Class PaynlMultibanco
 *
 * Multibanco - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlMultibanco extends AdminController {
	protected int $paymentOptionId = 2271;
	protected string $paymentMethodName = 'paynl_multibanco';
	protected string $defaultLabel = 'Multibanco';
}
