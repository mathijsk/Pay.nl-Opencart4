 ...
 *
 * VVV Giftcard - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlVvvgiftcard extends AdminController {
	protected int $paymentOptionId = 1714;
	protected string $paymentMethodName = 'paynl_vvvgiftcard';
	protected string $defaultLabel = 'VVV Giftcard';
}
