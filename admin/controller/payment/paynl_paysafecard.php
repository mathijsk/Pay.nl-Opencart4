...
/**
 * Class PaynlPaysafecard
 *
 * PaysafeCard - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlPaysafecard extends AdminController {
	protected int $paymentOptionId = 553;
	protected string $paymentMethodName = 'paynl_paysafecard';
	protected string $defaultLabel = 'PaysafeCard';
}
