 ...
 *
 * BBQ cadeaukaart - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlBbqcadeaukaart extends AdminController {
	protected int $paymentOptionId = 4233;
	protected string $paymentMethodName = 'paynl_bbqcadeaukaart';
	protected string $defaultLabel = 'BBQ cadeaukaart';
}
