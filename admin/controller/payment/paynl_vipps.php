 ...
 * Class PaynlVipps
 *
 * Vipps - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlVipps extends AdminController {
	protected int $paymentOptionId = 3834;
	protected string $paymentMethodName = 'paynl_vipps';
	protected string $defaultLabel = 'Vipps';
}
