...
/**
 * Class PaynlKidsorteen
 *
 * Kids or teen - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlKidsorteen extends AdminController {
	protected int $paymentOptionId = 3597;
	protected string $paymentMethodName = 'paynl_kidsorteen';
	protected string $defaultLabel = 'Kids or teen';
}
