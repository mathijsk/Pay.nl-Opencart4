 ...
 * Class PaynlFloa
 *
 * FLOA - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlFloa extends AdminController {
	protected int $paymentOptionId = 4815;
	protected string $paymentMethodName = 'paynl_floa';
	protected string $defaultLabel = 'FLOA';
}
