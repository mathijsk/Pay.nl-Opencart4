 ...
 * Class PaynlKlarnakp
 *
 * Klarna (Achteraf betalen) - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlKlarnakp extends AdminController {
	protected int $paymentOptionId = 1717;
	protected string $paymentMethodName = 'paynl_klarnakp';
	protected string $defaultLabel = 'Klarna (Achteraf betalen)';
}
