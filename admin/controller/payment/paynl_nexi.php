 ...
 * Class PaynlNexi
 *
 * Nexi - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlNexi extends AdminController {
	protected int $paymentOptionId = 1945;
	protected string $paymentMethodName = 'paynl_nexi';
	protected string $defaultLabel = 'Nexi';
}
