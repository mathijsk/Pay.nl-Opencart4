 ...
 * Class PaynlSodexo
 *
 * Sodexo - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlSodexo extends AdminController {
	protected int $paymentOptionId = 3030;
	protected string $paymentMethodName = 'paynl_sodexo';
	protected string $defaultLabel = 'Sodexo';
}
