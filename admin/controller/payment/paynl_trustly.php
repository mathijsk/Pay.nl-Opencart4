 ...
 * Class PaynlTrustly
 *
 * Trustly - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlTrustly extends AdminController {
	protected int $paymentOptionId = 2718;
	protected string $paymentMethodName = 'paynl_trustly';
	protected string $defaultLabel = 'Trustly';
}
