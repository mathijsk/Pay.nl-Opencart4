 ...
 *
 * Sports giftcard - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlSportsgiftcard extends AdminController {
	protected int $paymentOptionId = 4422;
	protected string $paymentMethodName = 'paynl_sportsgiftcard';
	protected string $defaultLabel = 'Sports giftcard';
}
