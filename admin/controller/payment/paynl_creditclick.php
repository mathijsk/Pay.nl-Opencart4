 ...
 *
 * CreditClick - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlCreditclick extends AdminController {
	protected int $paymentOptionId = 2107;
	protected string $paymentMethodName = 'paynl_creditclick';
	protected string $defaultLabel = 'CreditClick';
}
