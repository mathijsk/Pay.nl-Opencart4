 ...
 *
 * Sofortbanking Digital Services - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlSofortbankingds extends AdminController {
	protected int $paymentOptionId = 577;
	protected string $paymentMethodName = 'paynl_sofortbankingds';
	protected string $defaultLabel = 'Sofortbanking Digital Services';
}
