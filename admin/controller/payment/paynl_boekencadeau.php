 ...
 *
 * Boeken cadeau - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlBoekencadeau extends AdminController {
	protected int $paymentOptionId = 4749;
	protected string $paymentMethodName = 'paynl_boekencadeau';
	protected string $defaultLabel = 'Boeken cadeau';
}
