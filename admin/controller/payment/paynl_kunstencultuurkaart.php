 ...
 *
 * Kunst & Cultuur Kaart - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlKunstencultuurkaart extends AdminController {
	protected int $paymentOptionId = 3258;
	protected string $paymentMethodName = 'paynl_kunstencultuurkaart';
	protected string $defaultLabel = 'Kunst & Cultuur Kaart';
}
