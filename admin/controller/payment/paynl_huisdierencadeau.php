 ...
 *
 * Huisdieren cadeaukaart - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlHuisdierencadeau extends AdminController {
	protected int $paymentOptionId = 4158;
	protected string $paymentMethodName = 'paynl_huisdierencadeau';
	protected string $defaultLabel = 'Huisdieren cadeaukaart';
}
