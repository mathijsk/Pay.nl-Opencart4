 ...
 *
 * Rotterdam Citycard - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlRotterdamcitycard extends AdminController {
	protected int $paymentOptionId = 3603;
	protected string $paymentMethodName = 'paynl_rotterdamcitycard';
	protected string $defaultLabel = 'Rotterdam Citycard';
}
