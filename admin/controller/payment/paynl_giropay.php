 ...
 * Class PaynlGiropay
 *
 * Giropay - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlGiropay extends AdminController {
	protected int $paymentOptionId = 694;
	protected string $paymentMethodName = 'paynl_giropay';
	protected string $defaultLabel = 'Giropay';
}
