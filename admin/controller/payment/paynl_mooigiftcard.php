 ...
 *
 * MOOI giftcard - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlMooigiftcard extends AdminController {
	protected int $paymentOptionId = 3183;
	protected string $paymentMethodName = 'paynl_mooigiftcard';
	protected string $defaultLabel = 'MOOI giftcard';
}
