 ...
 *
 * Webshopgiftcard - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlWebshopgiftcard extends AdminController {
	protected int $paymentOptionId = 811;
	protected string $paymentMethodName = 'paynl_webshopgiftcard';
	protected string $defaultLabel = 'Webshopgiftcard';
}
