 ...
 *
 * Podium Cadeaukaart - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlPodiumcadeaukaart extends AdminController {
	protected int $paymentOptionId = 816;
	protected string $paymentMethodName = 'paynl_podiumcadeaukaart';
	protected string $defaultLabel = 'Podium Cadeaukaart';
}
