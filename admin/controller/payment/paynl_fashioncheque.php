...
/**
 * Class PaynlFashioncheque
 *
 * Fashioncheque - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlFashioncheque extends AdminController {
	protected int $paymentOptionId = 815;
	protected string $paymentMethodName = 'paynl_fashioncheque';
	protected string $defaultLabel = 'Fashioncheque';
}
