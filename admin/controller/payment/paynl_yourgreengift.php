...
/**
 * Class PaynlYourgreengift
 *
 * Your Green Gift Cadeaukaart - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlYourgreengift extends AdminController {
	protected int $paymentOptionId = 2925;
	protected string $paymentMethodName = 'paynl_yourgreengift';
	protected string $defaultLabel = 'Your Green Gift Cadeaukaart';
}
