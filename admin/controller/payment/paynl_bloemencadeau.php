 ...
 *
 * Bloemen Cadeaukaart - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlBloemencadeau extends AdminController {
	protected int $paymentOptionId = 2607;
	protected string $paymentMethodName = 'paynl_bloemencadeau';
	protected string $defaultLabel = 'Bloemen Cadeaukaart';
}
