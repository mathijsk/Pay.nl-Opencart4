 ...
 *
 * Stadspas Purmerend - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlStadspaspurmerend extends AdminController {
	protected int $paymentOptionId = 5177;
	protected string $paymentMethodName = 'paynl_stadspaspurmerend';
	protected string $defaultLabel = 'Stadspas Purmerend';
}
