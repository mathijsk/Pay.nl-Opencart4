...
/**
 * Class PaynlGroupedcreditcards
 *
 * Credit- & Debitcards - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlGroupedcreditcards extends AdminController {
	protected int $paymentOptionId = 11;
	protected string $paymentMethodName = 'paynl_groupedcreditcards';
	protected string $defaultLabel = 'Credit- & Debitcards';
}
