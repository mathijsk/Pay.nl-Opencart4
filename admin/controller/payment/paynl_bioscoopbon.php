 ...
 *
 * Bioscoopbon - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlBioscoopbon extends AdminController {
	protected int $paymentOptionId = 2133;
	protected string $paymentMethodName = 'paynl_bioscoopbon';
	protected string $defaultLabel = 'Bioscoopbon';
}
