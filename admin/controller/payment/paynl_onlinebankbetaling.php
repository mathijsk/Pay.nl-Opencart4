 ...
 *
 * Onlinebankbetaling - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlOnlinebankbetaling extends AdminController {
	protected int $paymentOptionId = 2970;
	protected string $paymentMethodName = 'paynl_onlinebankbetaling';
	protected string $defaultLabel = 'Onlinebankbetaling';
}
