 ...
 * Class PaynlRvrpas
 *
 * RVR-PAS - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlRvrpas extends AdminController {
	protected int $paymentOptionId = 4275;
	protected string $paymentMethodName = 'paynl_rvrpas';
	protected string $defaultLabel = 'RVR-PAS';
}
