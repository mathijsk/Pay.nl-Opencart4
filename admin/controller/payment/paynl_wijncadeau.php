...
/**
 * Class PaynlWijncadeau
 *
 * Wijncadeau - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlWijncadeau extends AdminController {
	protected int $paymentOptionId = 1666;
	protected string $paymentMethodName = 'paynl_wijncadeau';
	protected string $defaultLabel = 'Wijncadeau';
}
