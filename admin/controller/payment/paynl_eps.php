 ...
 * Class PaynlEps
 *
 * EPS Überweisung - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlEps extends AdminController {
	protected int $paymentOptionId = 2062;
	protected string $paymentMethodName = 'paynl_eps';
	protected string $defaultLabel = 'EPS Überweisung';
}
