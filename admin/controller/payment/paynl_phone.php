 ...
 * Class PaynlPhone
 *
 * Telefonisch betalen - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlPhone extends AdminController {
	protected int $paymentOptionId = 1600;
	protected string $paymentMethodName = 'paynl_phone';
	protected string $defaultLabel = 'Telefonisch betalen';
}
