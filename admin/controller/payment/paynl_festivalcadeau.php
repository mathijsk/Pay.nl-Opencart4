 ...
 *
 * Festival Cadeaukaart - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlFestivalcadeau extends AdminController {
	protected int $paymentOptionId = 2511;
	protected string $paymentMethodName = 'paynl_festivalcadeau';
	protected string $defaultLabel = 'Festival Cadeaukaart';
}
