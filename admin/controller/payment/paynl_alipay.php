 ...
 * Class PaynlAlipay
 *
 * AliPay - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlAlipay extends AdminController {
	protected int $paymentOptionId = 2080;
	protected string $paymentMethodName = 'paynl_alipay';
	protected string $defaultLabel = 'AliPay';
}
