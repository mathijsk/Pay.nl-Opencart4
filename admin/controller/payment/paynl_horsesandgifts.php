 ...
 *
 * Horses & Gifts - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlHorsesandgifts extends AdminController {
	protected int $paymentOptionId = 3222;
	protected string $paymentMethodName = 'paynl_horsesandgifts';
	protected string $defaultLabel = 'Horses & Gifts';
}
