 ...
 * Class PaynlTwint
 *
 * Twint - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlTwint extends AdminController {
	protected int $paymentOptionId = 3840;
	protected string $paymentMethodName = 'paynl_twint';
	protected string $defaultLabel = 'Twint';
}
