...
/**
 * Class PaynlAmazonpay
 *
 * Amazon Pay - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlAmazonpay extends AdminController {
	protected int $paymentOptionId = 1903;
	protected string $paymentMethodName = 'paynl_amazonpay';
	protected string $defaultLabel = 'Amazon Pay';
}
