 ...
 *
 * Sofortbanking - admin settings controller. Thin subclass of the shared
 ...
 */
class PaynlSofortbanking extends AdminController {
	protected int $paymentOptionId = 559;
	protected string $paymentMethodName = 'paynl_sofortbanking';
	protected string $defaultLabel = 'Sofortbanking';
}
