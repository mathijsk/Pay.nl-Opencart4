 ...
 * Class PaynlMaestro
 *
 * Maestro - catalog-side model. No method-specific logic needed;
 ...
 * to offer Maestro at all for a given order/address.
 *
 * @package Opencart\Catalog\Model\Extension\Paynl\Payment
 */
class PaynlMaestro extends Model {
	protected int $paymentOptionId = 712;
	protected string $paymentMethodName = 'paynl_maestro';
}
