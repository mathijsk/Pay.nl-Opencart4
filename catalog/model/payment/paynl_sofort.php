 ...
 * Class PaynlSofort
 *
 * Sofort (by Klarna) - catalog-side model. No method-specific logic needed;
 ...
 * to offer Sofort (by Klarna) at all for a given order/address.
 *
 * @package Opencart\Catalog\Model\Extension\Paynl\Payment
 */
class PaynlSofort extends Model {
