 ...
 * Class PaynlPhone
 *
 * Telefonisch betalen - catalog-side model. No method-specific logic needed;
 ...
 * to offer Telefonisch betalen at all for a given order/address.
 *
 * @package Opencart\Catalog\Model\Extension\Paynl\Payment
 */
class PaynlPhone extends Model {
