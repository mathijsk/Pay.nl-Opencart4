 ...
 * Class PaynlEps
 *
 * EPS Überweisung - catalog-side model. No method-specific logic needed;
 ...
 * to offer EPS Überweisung at all for a given order/address.
 *
 * @package Opencart\Catalog\Model\Extension\Paynl\Payment
 */
class PaynlEps extends Model {
