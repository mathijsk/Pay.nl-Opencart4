 ...
 * Class PaynlIdeal
 *
 * iDEAL - catalog (checkout) controller. Thin subclass of the shared
 * PaymentController: all real logic lives there, this just identifies
 * which Pay.nl payment option/method this page is for.
 *
 * @package Opencart\Catalog\Controller\Extension\Paynl\Payment
 */
class PaynlIdeal extends PaymentController {
